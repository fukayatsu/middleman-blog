...
module Middleman
  class BlogExtension < Extension
    ...
    # @return [CategoryPages] category page handler for this blog
    ...
    def after_configuration
      ...
      @app.ignore options.layout if options.layout
      ...
      if options.category_template
        ...
        @app.sitemap.register_resource_list_manipulator(:"blog_#{name}_categories", @category_pages)
      end
